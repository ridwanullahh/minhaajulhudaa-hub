      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-800 mb-6">
            Package Single <span className="text-platform-primary">Page</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            This is the package single page for Travels platform.
          ...
          {[1, 2, 3].map((item) => (
            <ModernCard key={item} variant="glass" className="p-8">
              <h3 className="text-xl font-bold text-gray-800 mb-4">
                Package Single Item {item}
              </h3>
              <p className="text-gray-600 mb-6">
                This is a placeholder for package single content. 
...
export default TravelsPackageSingle;