...
const ManageDonations = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => masjidDB.get('donations'));

  const handleDelete = async (id: string) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      try {
        await masjidDB.delete('donations', id);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/masjid/admin/donations/new">
      ...
      <DataState
        ...
        onEmptyAction={() => navigate('/masjid/admin/donations/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/masjid/admin/donations/edit/${item.id}`)}>
