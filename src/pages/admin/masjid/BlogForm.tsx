...
const BlogForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isEditing) {
        await masjidDB.update('blog_posts', id, post);
      } else {
        await masjidDB.insert('blog_posts', post);
      }
  ...
  return (
    <div>
      <div className="flex items-center mb-6">
        <ModernButton variant="outline" size="sm" onClick={() => navigate('/masjid/admin/blog')} className="mr-4">
