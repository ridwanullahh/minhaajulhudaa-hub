  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Manage Audio Library</h1>
          ...
          <TableBody>
            {tracks.map((track) => (
              <TableRow key={track.id}>
                ...
                <TableCell>{track.speaker}</TableCell>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => navigate(`/masjid/admin/audio/edit/${track.id}`)}>
