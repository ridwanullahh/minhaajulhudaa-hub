...
const ManageEvents = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => masjidDB.get('events'));
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">View and manage events</p>
        </div>
      ...
      <DataState
        ...
        emptyActionLabel="New Event"
        onEmptyAction={() => navigate('/masjid/admin/events/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
