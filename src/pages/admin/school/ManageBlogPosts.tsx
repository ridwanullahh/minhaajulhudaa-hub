...
const ManageBlogPosts = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => schoolDB.get('blog_posts'));
  ...
  return (
    <div>
      ...
      <DataState
        ...
        onEmptyAction={() => navigate('/school/admin/blog/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/school/admin/blog/edit/${item.id}`)}>
