...
const ManageClasses = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => schoolDB.get('classes'));
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">View and manage classes</p>
        </div>
      ...
      <DataState
        ...
        emptyActionLabel="New Class"
        onEmptyAction={() => navigate('/school/admin/classes/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/school/admin/classes/edit/${item.id}`)}>
