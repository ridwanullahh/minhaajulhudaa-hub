...
const ManageStudents = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => schoolDB.get('students'));
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">View and manage students</p>
        </div>
      ...
      <DataState
        ...
        emptyActionLabel="New Student"
        onEmptyAction={() => navigate('/school/admin/students/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/school/admin/students/edit/${item.id}`)}>
