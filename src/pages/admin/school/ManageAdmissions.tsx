...
const ManageAdmissions = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => schoolDB.get('admissions'));
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">View and manage admissions</p>
        </div>
      ...
      <DataState
        ...
        emptyActionLabel="New Admission"
        onEmptyAction={() => navigate('/school/admin/admissions/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/school/admin/admissions/edit/${item.id}`)}>
