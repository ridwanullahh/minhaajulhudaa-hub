...
const SchoolAdminDashboard = () => {
  const managementSections = [
    ...
    },
    {
      ...
      description: 'Manage contact details, socials, and other settings',
      icon: <Settings className="w-12 h-12" />,
      actions: [
        { name: 'General Settings', href: 'settings', icon: <Settings className="w-4 h-4" /> },
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-muted/50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Routes>
          ...
          <Route path="/settings" element={<SettingsForm platform="school" />} />
        </Routes>
      </div>
    </div>
  );
