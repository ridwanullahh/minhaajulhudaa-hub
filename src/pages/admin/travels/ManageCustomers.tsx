...
const ManageCustomers = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => travelsDB.get('customers'));

  const handleDelete = async (id: string) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      try {
        await travelsDB.delete('customers', id);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/travels/admin/customers/new">
      ...
      <DataState
        ...
        emptyActionLabel="New Customer"
        onEmptyAction={() => navigate('/travels/admin/customers/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/travels/admin/customers/edit/${item.id}`)}>
