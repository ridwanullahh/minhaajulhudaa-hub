...
const ManagePackages = () => {
  ...
  const { data: items, isLoading, error, refetch } = useListData(() => travelsDB.get('packages'));
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">View and manage packages</p>
        </div>
      ...
      <DataState
        ...
        emptyActionLabel="New Package"
        onEmptyAction={() => navigate('/travels/admin/packages/new')}
      >
        <ModernCard>
          <Table>
            <TableHeader>
