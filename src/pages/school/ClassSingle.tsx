      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-800 mb-6">
            Class Single <span className="text-platform-primary">Page</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            This is the class single page for School platform.
          ...
          {[1, 2, 3].map((item) => (
            <ModernCard key={item} variant="glass" className="p-8">
              ...
              <p className="text-gray-600 mb-6">
                This is a placeholder for class single content. 
